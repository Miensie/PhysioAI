...
app = FastAPI(
    ...
    description="Backend scientifique pour la modélisation physico-chimique assistée par IA.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
@app.get("/", tags=["Santé"])
async def root():
    return {"status": "ok", "app": "PhysioAI Lab", "version": "1.0.0"}
...
if __name__ == "__main__":
    ...
    logger.info(f"🚀 PhysioAI Lab → http://{host}:{port}")
